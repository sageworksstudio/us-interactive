  ...
  <div class="map-wrapper">
    ...
    <div class="map">
      <svg
        ...
        <g>
          <path
            @click="fetchUsState($event, 'AK')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'AL')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'AR')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'AZ')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'CA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'CO')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'CT')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'DE')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'FL')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'GA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'HI')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'IA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'ID')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'IL')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'IN')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'KY')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'KS')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'LA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'ME')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'MI')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'MN')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'MO')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NC')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'ND')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NE')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NH')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NJ')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NM')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NV')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'NY')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'OH')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'OK')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'OR')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'PA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'RI')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'SC')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'SD')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'TN')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'TX')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'UT')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'VA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'VT')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'WA')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'WI')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'WV')" class="state"
          ...
          <path
            @click="fetchUsState($event, 'WY')" class="state"
          ...
          <g @click="fetchUsState($event, 'DC')" class="state">
...
export default {
  ...
  methods: {
    fetchUsStates () {
      store.dispatch('usStates/fetchUsStates')
        .then(() => {
    ...
    fetchUsState (event, state) {
      event.srcElement.classList.add('active')
      store.dispatch('usStates/fetchUsState', {
        id: state
      })
        .then(() => {
          this.hide = false
