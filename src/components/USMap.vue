  ...
  <div class="map-wrapper">
    ...
    <div class="info-box" v-if="!hide">
      <div class="info-box__card">
        <button @click="close()" class="info-box__card--closer">×</button>
    ...
    <div class="map">
      <svg
        ...
        <g>
          <path
            @click="fetchSingleState($event, 'AK')" class="state" id="AK"
          ...
          <path
            @click="fetchSingleState($event, 'AL')" class="state" id="AL"
          ...
          <path
            @click="fetchSingleState($event, 'AR')" class="state" id="AR"
          ...
          <path
            @click="fetchSingleState($event, 'AZ')" class="state" id="AZ"
          ...
          <path
            @click="fetchSingleState($event, 'CA')" class="state" id="CA"
          ...
          <path
            @click="fetchSingleState($event, 'CO')" class="state" id="CO"
          ...
          <path
            @click="fetchSingleState($event, 'CT')" class="state" id="CT"
          ...
          <path
            @click="fetchSingleState($event, 'DE')" class="state" id="DE"
          ...
          <path
            @click="fetchSingleState($event, 'FL')" class="state" id="FL"
          ...
          <path
            @click="fetchSingleState($event, 'GA')" class="state" id="GA"
          ...
          <path
            @click="fetchSingleState($event, 'HI')" class="state" id="HI"
          ...
          <path
            @click="fetchSingleState($event, 'IA')" class="state" id="IA"
          ...
          <path
            @click="fetchSingleState($event, 'ID')" class="state" id="ID"
          ...
          <path
            @click="fetchSingleState($event, 'IL')" class="state" id="IL"
          ...
          <path
            @click="fetchSingleState($event, 'IN')" class="state" id="IN"
          ...
          <path
            @click="fetchSingleState($event, 'KY')" class="state" id="KY"
          ...
          <path
            @click="fetchSingleState($event, 'KS')" class="state" id="KS"
          ...
          <path
            @click="fetchSingleState($event, 'LA')" class="state" id="LA"
          ...
          <path
            @click="fetchSingleState($event, 'MA')" class="state" id="MA"
            d="M1074,273.9l2.2-0.7l0.5-1.7l1,0.1l1,2.3l-1.3,0.5l-3.9,0.1L1074,273.9z M1064.6,274.7l2.3-2.6h1.6   l1.8,1.5l-2.4,1l-2.2,1L1064.6,274.7z M1029.8,252.7l17.5-4.2l2.3-0.6l2.1-3.2l3.7-1.7l2.9,4.4l-2.4,5.2l-0.3,1.5l1.9,2.6l1.1-0.8   h1.8l2.3,2.6l3.9,6l3.6,0.5l2.3-1l1.8-1.8l-0.8-2.7l-2.1-1.6l-1.5,0.8l-1-1.3l0.5-0.5l2.1-0.2l1.8,0.8l1.9,2.4l1,2.9l0.3,2.4   l-4.2,1.5l-3.9,1.9l-3.9,4.5l-1.9,1.5v-1l2.4-1.5l0.5-1.8l-0.8-3.1l-2.9,1.5l-0.8,1.5l0.5,2.3l-2.1,1l-2.7-4.5l-3.4-4.4l-2.1-1.8   l-6.5,1.9l-5.1,1.1l-21.8,4.8l-0.4-4.9l0.6-10.6l5.2-0.9L1029.8,252.7z"/>
          <path
            @click="fetchSingleState($event, 'MD')" class="state" id="MD"
          ...
          <path
            @click="fetchSingleState($event, 'ME')" class="state" id="ME"
          ...
          <path
            @click="fetchSingleState($event, 'MI')" class="state" id="MI"
          ...
          <path
            @click="fetchSingleState($event, 'MN')" class="state" id="MN"
          ...
          <path
            @click="fetchSingleState($event, 'MO')" class="state" id="MO"
          ...
          <path
            @click="fetchSingleState($event, 'NC')" class="state" id="NC"
          ...
          <path
            @click="fetchSingleState($event, 'ND')" class="state" id="ND"
          ...
          <path
            @click="fetchSingleState($event, 'NE')" class="state" id="NE"
          ...
          <path
            @click="fetchSingleState($event, 'NH')" class="state" id="NH"
          ...
          <path
            @click="fetchSingleState($event, 'NJ')" class="state" id="NJ"
          ...
          <path
            @click="fetchSingleState($event, 'NM')" class="state" id="NM"
          ...
          <path
            @click="fetchSingleState($event, 'NV')" class="state" id="NV"
          ...
          <path
            @click="fetchSingleState($event, 'NY')" class="state" id="NY"
          ...
          <path
            @click="fetchSingleState($event, 'OH')" class="state" id="OH"
          ...
          <path
            @click="fetchSingleState($event, 'OK')" class="state" id="OK"
          ...
          <path
            @click="fetchSingleState($event, 'OR')" class="state" id="OR"
          ...
          <path
            @click="fetchSingleState($event, 'PA')" class="state" id="PA"
          ...
          <path
            @click="fetchSingleState($event, 'RI')" class="state" id="RI"
          ...
          <path
            @click="fetchSingleState($event, 'SC')" class="state" id="SC"
          ...
          <path
            @click="fetchSingleState($event, 'SD')" class="state" id="SD"
          ...
          <path
            @click="fetchSingleState($event, 'TN')" class="state" id="TN"
          ...
          <path
            @click="fetchSingleState($event, 'TX')" class="state" id="TX"
          ...
          <path
            @click="fetchSingleState($event, 'UT')" class="state" id="UT"
          ...
          <path
            @click="fetchSingleState($event, 'VA')" class="state" id="VA"
          ...
          <path
            @click="fetchSingleState($event, 'VT')" class="state" id="VT"
          ...
          <path
            @click="fetchSingleState($event, 'WA')" class="state" id="WA"
          ...
          <path
            @click="fetchSingleState($event, 'WI')" class="state" id="WI"
          ...
          <path
            @click="fetchSingleState($event, 'WV')" class="state" id="WV"
          ...
          <path
            @click="fetchSingleState($event, 'WY')" class="state" id="WY"
          ...
          <g @click="fetchSingleState($event, 'DC')" class="state" id="DC">
            <path d="M975.8,353.8l-1.1-1.6l-1-0.8l1.1-1.6l2.2,1.5L975.8,353.8z"/>
            <circle stroke="#FFFFFF" stroke-width="1.5" cx="975.3" cy="351.8" r="5"/>
          </g>
        </g>
      </svg>
    </div>
...
import { state } from '@/store/modules/us-states'
export default {
  name: 'USMap',
  ...
  methods: {
    fetchAllStates () {
      store.dispatch('usStates/fetchAllStates')
        .then(() => {
